...
<form action="server/php/proccess.php" method="POST">
	<p>Nombre viejo </p><input class="input" type="password" name="user">
	<p>Nuevo nombre </p><input class="input" type="password" name="newUser">
	<input style="display: none" name="function" value="changeName">
...
<form action="server/php/proccess.php" method="POST">
	<p>contraseña vieja </p><input class="input" type="password" name="pssword">
	<p>Contraseña nueva </p><input class="input" type="password" name="newUser">
	<p>Repite la contraseña </p><input class="input" type="password" name="newUser">
	<input style="display: none" name="function" value="changeName">
	<div><input type="submit" value="Confirmar"></div>
</form>
</div>
